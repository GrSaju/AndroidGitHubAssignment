...
class CreateRepositoryResponseModel {
    ...
    @Expose
    var allowAutoMerge: Boolean? = null

    @SerializedName("delete_branch_on_merge")
    @Expose
    var deleteBranchOnMerge: Boolean? = null

    @SerializedName("allow_update_branch")
    @Expose
    var allowUpdateBranch: Boolean? = null

    @SerializedName("use_squash_pr_title_as_default")
    @Expose
    var useSquashPrTitleAsDefault: Boolean? = null

    @SerializedName("squash_merge_commit_message")
    @Expose
    var squashMergeCommitMessage: String? = null

    @SerializedName("squash_merge_commit_title")
    @Expose
    var squashMergeCommitTitle: String? = null

    @SerializedName("merge_commit_message")
    @Expose
    var mergeCommitMessage: String? = null

    @SerializedName("merge_commit_title")
    @Expose
    var mergeCommitTitle: String? = null
